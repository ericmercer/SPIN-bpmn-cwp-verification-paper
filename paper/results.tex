...
\begin{figure*}[t]
  \begin{center}
    \begin{tabular}{c}
      \includegraphics[scale=0.60]{proof-digest.png}
    \end{tabular}
  \end{center}
...
The results for the state properties for \texttt{ptInElevatedRiskHomeCare} with the measured time verifying the entire model is shown in \figref{fig:proof}. Verification takes around three to four minutes on an Intel Core i7 laptop with 16 Gb of RAM. It is not taxing the system in any way. 
