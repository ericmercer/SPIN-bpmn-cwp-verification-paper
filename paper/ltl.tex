The finite state machine in \figref{fig:cwp} is a recognized standard for software specifications.
...
Such an atomic proposition is defined similarly for each of the other states in \figref{fig:cwp}.
...
The goal states for the CWP in \figref{fig:cwp} have no outgoing transitions and are the \emph{Pt expired} and \emph{Pt discharged} states.
%
{\small
\begin{lstlisting}[style=myPromela]
